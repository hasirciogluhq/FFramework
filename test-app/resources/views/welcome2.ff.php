...
<body class="dark min-h-full bg-zinc-950 text-zinc-200 antialiased selection:bg-red-500/40 selection:text-white">
    ...
    <main class="relative z-10 flex min-h-screen flex-col">
        ...
        <div class="mx-auto w-full max-w-5xl flex-1 px-4 pb-12 pt-16 sm:px-6 sm:pt-20 lg:px-8">
            ...
            <!-- Zarif Ayırıcı Çizgi -->
            <div class="mx-auto mt-20 mb-16 h-px w-3/4 max-w-2xl bg-gradient-to-r from-transparent via-zinc-700/50 to-transparent" aria-hidden="true"></div>

            <!-- Önceden Footer Olan İçeriğin Sayfaya Entegre Edilmiş Hali (Ortalanmış ve Simetrik) -->
            <div class="flex flex-col items-center justify-center">

                <!-- Marka Alanı -->
                <div class="mb-12 text-center">
                    <a href="<?php echo Kernel::$config->get('site.ssl') . '://' . Kernel::$config->get('site.domain'); ?>"
                        class="inline-flex items-center gap-2 text-2xl font-semibold tracking-tight text-white transition hover:text-red-400">
                        <span class="flex h-9 w-9 items-center justify-center rounded-xl bg-red-600/20 text-base font-bold text-red-400 shadow-depth-sm">F</span>
                        FFramework
                    </a>
                    <p class="mx-auto mt-4 max-w-md text-sm leading-relaxed text-zinc-500">
                        A minimal, fast, extensible starting point for modern PHP. Built with passion.
                    </p>
                </div>

                <!-- Linkler Grid Alanı -->
                <div class="w-full max-w-4xl rounded-3xl border border-zinc-800/50 bg-zinc-900/20 p-8 shadow-depth-sm backdrop-blur-md sm:p-10">
                    <div class="grid grid-cols-2 gap-x-8 gap-y-12 text-center sm:grid-cols-4">
                        <div>
                        ...
                        <div>
                            <h2 class="mb-4 text-xs font-bold uppercase tracking-widest text-zinc-300">Legal</h2>
                            <ul class="space-y-3 text-sm text-zinc-500">
                ...
                <!-- Sosyal İkonlar ve Telif -->
                <div class="mt-12 flex flex-col items-center gap-6">
                    <div class="flex flex-wrap items-center justify-center gap-6">
                        <!-- Facebook -->
                        <a href="https://facebook.com/hsrcpay" target="_blank" rel="noopener noreferrer" class="rounded-full bg-zinc-900/50 p-2.5 text-zinc-500 border border-zinc-800/50 transition duration-200 hover:bg-zinc-800 hover:text-red-400 hover:shadow-glow-red" aria-label="Facebook">
                            <svg class="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                                <path fill-rule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clip-rule="evenodd"></path>
                            </svg>
                        </a>
                        <!-- Instagram -->
                        <a href="https://instagram.com/hsrcpay" target="_blank" rel="noopener noreferrer" class="rounded-full bg-zinc-900/50 p-2.5 text-zinc-500 border border-zinc-800/50 transition duration-200 hover:bg-zinc-800 hover:text-red-400 hover:shadow-glow-red" aria-label="Instagram">
                            <svg class="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                        ...
                        <!-- Twitter -->
                        <a href="https://twitter.com/hsrcpay" target="_blank" rel="noopener noreferrer" class="rounded-full bg-zinc-900/50 p-2.5 text-zinc-500 border border-zinc-800/50 transition duration-200 hover:bg-zinc-800 hover:text-red-400 hover:shadow-glow-red" aria-label="Twitter">
                            <svg class="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                                <path d="M8.29 20.251c7.547 0 11.675-6.253 11.675-11.675 0-.178 0-.355-.012-.53A8.348 8.348 0 0022 5.92a8.19 8.19 0 01-2.357.646 4.118 4.118 0 001.804-2.27 8.224 8.224 0 01-2.605.996 4.107 4.107 0 00-6.993 3.743 11.65 11.65 0 01-8.457-4.287 4.106 4.106 0 001.27 5.477A4.072 4.072 0 012.8 9.713v.052a4.105 4.105 0 003.292 4.022 4.095 4.095 0 01-1.853.07 4.108 4.108 0 003.834 2.85A8.233 8.233 0 012 18.407a11.616 11.616 0 006.29 1.84"></path>
                            </svg>
                        </a>
                        <!-- GitHub -->
                        <a href="https://github.com/hsrcpay" target="_blank" rel="noopener noreferrer" class="rounded-full bg-zinc-900/50 p-2.5 text-zinc-500 border border-zinc-800/50 transition duration-200 hover:bg-zinc-800 hover:text-red-400 hover:shadow-glow-red" aria-label="GitHub">
                            <svg class="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                        ...
                        <!-- Discord -->
                        <a href="https://discord.gg/y38CZgHMMq" target="_blank" rel="noopener noreferrer" class="rounded-full bg-zinc-900/50 p-2.5 text-zinc-500 border border-zinc-800/50 transition duration-200 hover:bg-zinc-800 hover:text-red-400 hover:shadow-glow-red" aria-label="Discord">
                            <svg class="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                    ...
                    <p class="text-xs text-zinc-600">
                        © <?php echo date('Y'); ?> FFramework™. All rights reserved.
                    </p>
                </div>
