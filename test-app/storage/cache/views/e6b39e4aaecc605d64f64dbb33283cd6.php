...
<body class="dark min-h-full bg-zinc-950 text-zinc-200 antialiased selection:bg-red-500/40 selection:text-white">
    ...
    <main class="relative z-10">
        <div class="mx-auto max-w-5xl px-4 pb-20 pt-16 sm:px-6 sm:pt-20 lg:px-8">
            ...
            <section class="relative mt-14 overflow-hidden rounded-2xl border border-zinc-800/80 bg-zinc-900/35 p-6 shadow-depth-lg backdrop-blur-sm sm:mt-16 sm:p-8" aria-label="Docs, contact, and legal">
                <div class="pointer-events-none absolute -right-8 top-0 h-40 w-40 rounded-full bg-red-600/10 blur-3xl" aria-hidden="true"></div>
                <div class="relative flex flex-col gap-10 lg:flex-row lg:items-start lg:justify-between">
                    <div class="max-w-sm">
                        <a href="<?php echo Kernel::$config->get('site.ssl') . '://' . Kernel::$config->get('site.domain'); ?>"
                            class="inline-flex items-center gap-2 text-lg font-semibold tracking-tight text-white transition hover:text-red-400 sm:text-xl">
                            <span class="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-red-600/20 text-sm font-bold text-red-400 shadow-depth-sm">F</span>
                            FFramework
                        </a>
                        <p class="mt-3 text-sm leading-relaxed text-zinc-500">
                            Docs, contact, socials, and legal — same page, no footer strip.
                        </p>
                    </div>
                    <div class="grid flex-1 grid-cols-2 gap-x-8 gap-y-8 sm:grid-cols-4 lg:max-w-3xl lg:justify-end">
                        <div>
                            <h2 class="mb-3 text-xs font-semibold uppercase tracking-wider text-zinc-500">Document</h2>
                            <ul class="space-y-2.5 text-sm text-zinc-400">
                                <li><a href="#" class="transition hover:text-red-400">API Documentations</a></li>
                            </ul>
                        </div>
                        <div>
                            <h2 class="mb-3 text-xs font-semibold uppercase tracking-wider text-zinc-500">Contact</h2>
                            <ul class="space-y-2.5 text-sm text-zinc-400">
                        ...
                        <div>
                            <h2 class="mb-3 text-xs font-semibold uppercase tracking-wider text-zinc-500">Follow</h2>
                            <ul class="space-y-2.5 text-sm text-zinc-400">
                        ...
                        <div>
                            <h2 class="mb-3 text-xs font-semibold uppercase tracking-wider text-zinc-500">Legal</h2>
                            <ul class="space-y-2.5 text-sm text-zinc-400">
                ...
                <div class="relative mt-8 flex flex-col items-center justify-between gap-5 border-t border-zinc-800/80 pt-8 sm:flex-row">
                    <p class="text-center text-sm text-zinc-500 sm:text-left">
                        © <?php echo date('Y'); ?>
                        <span class="text-zinc-400">FFramework™</span> — all rights reserved.
                    </p>
